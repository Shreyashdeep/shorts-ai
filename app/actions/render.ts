...
export const renderVideo = async (videoId: string) => {
    try {
        ...
        const { bucketName, renderId } = await renderMediaOnLambda({
            region: 'us-east-1',
            functionName: 'remotion-render-4-0-340-mem2048mb-disk2048mb-120sec',
            composition: 'MyVideo',
            // serveUrl: 'https://remotionlambda-eunorth1-s689byx4j6.s3.eu-north-1.amazonaws.com/sites/shorts69/index.html',
            serveUrl: 'https://remotionlambda-useast1-5gbdgplnnj.s3.us-east-1.amazonaws.com/sites/shorts-ai/index.html',
            codec: 'h264',
            inputProps: {
